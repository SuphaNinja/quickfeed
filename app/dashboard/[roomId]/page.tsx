...
function DashboardPage() {
    ...
    const { data: projectRoom, isLoading, isError, isSuccess } = useQuery({
    ...
    const project: ProjectRoom = projectRoom?.data;
            ...
            <div>
                <div className="flex w-full h-screen">
                    <div className='hidden md:block'>
                        <DashboardSidebar setActiveTab={setActiveTab} projectRoom={project} />
                    </div>
                    <div className="flex-1 overflow-auto">
                        ...
                        {activeTab === "Dashboard" && (
                            <Dashboard projectRoom={project} />
                        )}
                        {activeTab === "Feedbacks" && (
                            <Feedbacks projectRoom={project} />
                        )}
                        {activeTab === "Analysis" && (
                            <Analysis projectRoom={project} />
                        )}
                        {activeTab === "Tasks" && (
                            <Tasks projectRoom={project} />
                        )}
                    </div>
                </div>
            </div>
